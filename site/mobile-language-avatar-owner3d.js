(() => {
  'use strict';
  const VERSION = '0.3.2R4F12R8R15-owner-rig-v3-headsafe';
...
(() => {
  ...
  const MODEL_CHUNKS=Array.from({length:18},(_,i)=>`./assets/owner3d-rig-v3/chunk_${String(i).padStart(3,'0')}.txt?v=rigv3-98cb49d3`);
