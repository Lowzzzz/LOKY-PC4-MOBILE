...
assert.equal(api.version,'0.3.2R4F10-cloud-web-search');
...
assert(src.includes("const SEARCH_DEBOUNCE_MS=420"));
...
assert(src.includes("[LOKY WEB SEARCH — RESULTADO VERIFICADO]"));
assert(src.includes("RESULTADO VERIFICADO"));
