...
assert(/const VERSION='0\.3\.2R4F(?:5(?:-devices-qr|R3-settings-dashboard-clean|R4-guest-handoff)|7(?:-voice-personality-ui|R1-voice-preview-confirm|R2-instant-voice-preview))'/.test(settings));
