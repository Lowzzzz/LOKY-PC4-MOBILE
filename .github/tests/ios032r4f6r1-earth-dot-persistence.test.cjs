...
assert(earth.includes("const VERSION='0.3.2R4F6R1-earth-dot-persistence'"));
...
assert(earth.includes('const baseSize=Math.max(.75,w/1080),stride=fast?FAST_DOT_STRIDE:1;'));
...
console.log('R4F6R1 Earth dot persistence during motion PASS');
