...
// Supabase deployment version: 17
// EZBR SHA256: bd5e65cbe3aca95da08e184aacfc496db568227fadadbcedfd5776af9d3ec06b
// Captured before cross-provider local-search fallback.
...
async function localContactSearch(query:string,scope:any){
  ...
  add(`${scope.entity} ${scope.location}${country} teléfono`);
